...
import { Home, Calendar, Users, BookOpen, User, LogOut, Menu, X } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import Avatar from '../../components/ui/avatar';

const links = [
  { to: '/therapist', label: 'Dashboard', icon: Home, end: true },
  { to: '/therapist/schedule', label: 'Schedule', icon: Calendar },
  { to: '/therapist/clients', label: 'Clients', icon: Users },
  { to: '/therapist/workshops', label: 'Workshops', icon: BookOpen },
    ...
    <>
      <div className="px-4 pt-5 pb-4">
        <a href="/" className="flex items-center gap-2.5 no-underline hover:no-underline">
          <svg width="26" height="26" viewBox="0 0 28 28" fill="none"><circle cx="14" cy="14" r="14" fill="url(#tlg)"/><path d="M8 14.5C8 14.5 10.5 9 14 9C17.5 9 20 14.5 20 14.5C20 14.5 17.5 20 14 20C10.5 20 8 14.5 8 14.5Z" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="14" cy="14.5" r="2.5" fill="#fff"/><defs><linearGradient id="tlg" x1="0" y1="0" x2="28" y2="28"><stop stopColor="#6366f1"/><stop offset="1" stopColor="#8b5cf6"/></linearGradient></defs></svg>
          <span className="text-[17px] font-semibold text-text-primary">feelya</span>
          <span className="text-[11px] font-medium text-violet bg-violet/10 px-2 py-0.5 rounded-full">Therapist</span>
        </a>
      </div>
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-[260px] bg-surface flex flex-col shadow-elevated animate-slide-in">
            <div className="flex items-center justify-between px-4 pt-5 pb-4">
              <a href="/" className="flex items-center gap-2.5 no-underline hover:no-underline">
                <svg width="26" height="26" viewBox="0 0 28 28" fill="none"><circle cx="14" cy="14" r="14" fill="url(#tlg2)"/><path d="M8 14.5C8 14.5 10.5 9 14 9C17.5 9 20 14.5 20 14.5C20 14.5 17.5 20 14 20C10.5 20 8 14.5 8 14.5Z" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><circle cx="14" cy="14.5" r="2.5" fill="#fff"/><defs><linearGradient id="tlg2" x1="0" y1="0" x2="28" y2="28"><stop stopColor="#6366f1"/><stop offset="1" stopColor="#8b5cf6"/></linearGradient></defs></svg>
                <span className="text-[17px] font-semibold text-text-primary">feelya</span>
              </a>
